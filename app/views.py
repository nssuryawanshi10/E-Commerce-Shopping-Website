...
def bottomwear(request,data=None):
    if data == None:
     ...
     bottomwears = Product.objects.filter(category='BW').filter(discounted_price__lt=1100)
    elif data == 'above':
     bottomwears = Product.objects.filter(category='BW').filter(discounted_price__gt=1100)
